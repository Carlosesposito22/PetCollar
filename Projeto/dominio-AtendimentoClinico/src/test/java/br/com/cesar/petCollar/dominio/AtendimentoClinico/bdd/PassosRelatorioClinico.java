...
public class PassosRelatorioClinico {
    ...
    @Dado("existe um relatorio nao assinado com diagnostico e orientacoes preenchidos")
    ...
    @Dado("existe um relatorio nao assinado sem diagnostico tecnico")
    ...
    @Quando("o servico tentar assinar o relatorio sem diagnostico")
